...
void Kleaner::setup()
{
  ...
  mProcessRinseState.add_process_step(new ProcessStepCo2On(10));
  ...
  mProcessSaniState.add_process_step(new ProcessStepCo2On(10));
  ...
  mProcessWashState.add_process_step(new ProcessStepCo2Off());
